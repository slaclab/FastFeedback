...
# Note: contains parameters specific to sioc-b34-tr02 and
...
# How to escape the "sioc-b34-tr02" as the PERL program
...
# Using sioc-ltus-tr02 macros for sending the states:
epicsEnvSet("FB", "FB05")
