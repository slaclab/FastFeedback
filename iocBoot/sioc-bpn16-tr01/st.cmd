...
# How to escape the "sioc-l2b-tr01" as the PERL program
...
#System Location:
epicsEnvSet("FB", "FB06")
epicsEnvSet("LOOP", "TR06")
epicsEnvSet("CONFIG_NAME", "Bypass Launch")

# Which BY1 bend magnet do we want to read energy from?
epicsEnvSet("BEND_MAG", "BEND:DOG:110:BACT")
