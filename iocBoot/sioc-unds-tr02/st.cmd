...
# Note: contains parameters specific to sioc-unds-tr02 and
...
# How to escape the "sioc-unds-tr02" as the PERL program
...
epicsEnvSet("CONFIG_NAME", "UNDS Launch 2")
...
dbLoadRecords("db/bsaFbck.db",  "D=FBCK:UNDS:1, EG=mm,   HO=10, LO=-10, AD=5, PR=3, I='FBCK:UNDS:1:X_POS', LNK='', ATTR=X_POS, INP=STATE1, SINK_SIZE=1")
dbLoadRecords("db/bsaFbck.db",  "D=FBCK:UNDS:1, EG=mrad, HO=10, LO=-10, AD=5, PR=3, I='FBCK:UNDS:1:X_ANG', LNK='', ATTR=X_ANG, INP=STATE2, SINK_SIZE=1")
dbLoadRecords("db/bsaFbck.db",  "D=FBCK:UNDS:1, EG=mm,   HO=10, LO=-10, AD=5, PR=3, I='FBCK:UNDS:1:Y_POS', LNK='', ATTR=Y_POS, INP=STATE3, SINK_SIZE=1")
dbLoadRecords("db/bsaFbck.db",  "D=FBCK:UNDS:1, EG=mrad, HO=10, LO=-10, AD=5, PR=3, I='FBCK:UNDS:1:Y_ANG', LNK='', ATTR=Y_ANG, INP=STATE4, SINK_SIZE=1")
